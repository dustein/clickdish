...
//     // Clone com position:relative + dimensões de exportação
//     const clone = cardElement.cloneNode(true) as HTMLElement;
//     clone.style.position = 'relative';   // <- NUNCA absolute
//     clone.style.top = '0px';
...
//             {/* Wrapper que mantém a proporção 4:5 na tela — overflow-hidden
//                 garante que o card nunca ultrapasse a altura 4:5, nem na
//                 captura nem visualmente. */}
